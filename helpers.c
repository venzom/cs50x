...
void blur(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    for (int i = 0; i <= height; i++)
    {
        for (int j = 0; j <=width; j++)
        {
            ...
            {
                avgR = (image[i][j-1].rgbtRed + image[i][j].rgbtRed + image[i][j+1].rgbtRed 
                + image[i+1][j-1].rgbtRed+ image[i+1][j].rgbtRed+ image[i+1][j+1].rgbtRed) / 6.0;
                
                avgG = (image[i][j-1].rgbtGreen + image[i][j].rgbtGreen + image[i][j+1].rgbtGreen
                + image[i+1][j-1].rgbtGreen+ image[i+1][j].rgbtGreen+ image[i+1][j+1].rgbtGreen) / 6.0;
                
                avgB = (image[i][j-1].rgbtBlue + image[i][j].rgbtBlue + image[i][j+1].rgbtBlue
